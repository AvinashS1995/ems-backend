...
const userSchema = new mongoose.Schema({
  ...
  bankAccNo: { type: String, unique: true }, // 12-digit
  pfNo: { type: String, unique: true }, // 22-digit alphanumeric
  uan: { type: String, unique: true }, // 12-digit
  pan: { type: String, unique: true }, // 10-digit alphanumeric (standard PAN)
